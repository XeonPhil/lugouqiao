...
Page({
  ...
  onReady: function (e) {
    ...
    app.menuConfig = {
      menu: [
        { 'index': 0, 'menu': '我的', 'src': '../images/alert_horn.png' },
        { 'index': 1, 'menu': '高数', 'src': '../images/open_book.png' },
        { 'index': 2, 'menu': '计算机网络', 'src': '../images/open_book2.png' },
        { 'index': 3, 'menu': '图形学', 'src': '../images/alert_horn2.png' },
        { 'index': 4, 'menu': '多媒体', 'src':'../images/alert_horn.png' },
        { 'index': 5, 'menu': 'C语言', 'src': '../images/paper_plane.png' }
      ]
    }
    // 绘制转盘
